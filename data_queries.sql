...
SELECT departments.dept_no, departments.dept_no, 
...
SELECT dept_emp.dept_no, employees.employee_number, employees.last_name,
	   employees.first_name, departments.dept_no
FROM dept_emp
JOIN employees
...
FROM departments
JOIN dept_emp
	ON departments.dept_number = dept_emp.dept_no
JOIN employees
